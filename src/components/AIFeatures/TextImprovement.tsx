...
const TextImprovement: React.FC<TextImprovementProps> = ({
  ...
  return (
    <div className="relative group">
      <div className="absolute right-2 top-[-2rem] group">
        <svg
          version="1.0"
          ...
          fill="currentColor"
          className="w-6 h-6 text-purple-600 hover:text-purple-800 transition-colors duration-300 cursor-pointer"
        >
          <g
      ...
      <div className="absolute group right-10 top-[-2rem] flex flex-col space-y-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible  transition-opacity duration-300">
